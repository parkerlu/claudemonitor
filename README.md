...
- 常用句收藏 / 历史复用（客服类场景 80% 的话是重复的）
- 多候选横滑（一次给 2–3 个不同语气的版本）
- 端侧草稿层：Apple Translation framework 或 iOS 26 的 Foundation Models 出即时版，
  云端再静默替换成润色版。**需要先在真机验证这两个 framework 在 App Extension 里能否使用**
- 中式表达 / 可能显得无礼的措辞高亮
